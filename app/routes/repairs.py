...
async def _build_invoice_data(repair, response, db, estimate=False):
    ...
    return {
        ...
        "handover_items": response.handover_items,
        "handover_memory_note": response.handover_memory_note,
        "condition_data": response.condition_data,
        "parts": [
            {
...
async def build_repair_response(r: Repair, db) -> RepairResponse:
    ...
    return RepairResponse(
        ...
        status=r.status, model=r.model, brand=r.brand or "",
        passcode=r.passcode or "",
        issues=r.issues, imei=r.imei, estimated_cost=r.estimated_cost,
        ...
        notes=r.notes or "",
        handover_items=r.handover_items or "[]",
        handover_memory_note=r.handover_memory_note or "",
        condition_data=r.condition_data or "{}",
...
async def create_repair(
    ...
    repair = Repair(
        ...
        model=data.model, brand=data.brand, passcode=data.passcode,
        issues=data.issues, imei=data.imei,
        ...
        handover_memory_note=data.handover_memory_note,
